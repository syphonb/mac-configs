...
lvim.keys.normal_mode["<C-j>"] = ":m .+1<CR>==" -- Move line down one
lvim.keys.normal_mode["<C-k>"] = ":m .-2<CR>==" -- Move line up one

lvim.keys.insert_mode["jk"] = "<Esc>`^"

lvim.keys.visual_mode["<C-j>"] = ":m '>+1<CR>gv==gv" -- Move line down one
lvim.keys.visual_mode["<C-k>"] = ":m '<-2<CR>gv==gv" -- Move line up one
